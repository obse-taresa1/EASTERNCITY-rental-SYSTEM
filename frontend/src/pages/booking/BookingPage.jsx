...
import { createBooking } from "../../services/bookingApiService.js";
  ...
  const handleSubmitBooking = async () => {
    ...
    try {
      await createBooking({
        ...
        owner: item.ownerName || item.owner?.name || "Verified Owner",
        startDate,
        endDate,
        subtotal,
        serviceFee,
      ...
      navigate("/my-bookings", {
        state: {
          successMessage:
            "Booking request submitted. The owner can accept or reject it. Payment for this rental is arranged directly between you and the item owner.",
        },
      });
    } catch (error) {
      console.error(error);
        ...
        <div className="booking-modal-content mx-auto p-4 p-md-5">
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    height: "28px",
                    background:
                      step >= num ? "var(--motorx-red)" : "var(--border)",
                  }}
                >
                  {num}
                </div>
          ...
          {step === 1 && (
            <div className="booking-flow-step animate__animated animate__fadeIn">
              ...
              {days > 0 && (
                <div className="bg-light p-4 rounded-3 mt-3">
                  ...
                  <div className="d-flex justify-content-between mb-2">
                    <span>
                      {formatDailyPrice(dailyPrice)} x {days} days
                    </span>
              ...
              <button
                className="btn btn-danger w-100 btn-lg mt-3 fw-bold rounded-pill"
            ...
            <div className="booking-flow-step animate__animated animate__fadeIn">
              <div className="bg-light p-4 rounded-3 border">
                <h4 className="fw-bold mb-3">
                  <i className="bi bi-send-check text-danger"></i> Submit
                  Booking Request
                </h4>
                <ul className="text-muted">
                  <li className="mb-2">
                    Your request will be sent to the item owner.
                  </li>
                  <li className="mb-2">
                    The owner can accept or reject the request.
                  </li>
                  <li>
                    Payment for this rental is arranged directly between you and
                    the item owner.
                  </li>
                </ul>
              </div>
              ...
              <label className="d-flex align-items-start gap-3 p-3 border rounded-3 cursor-pointer mt-3 bg-light">
                ...
                <span className="fw-medium">
                  I have read and agree to the EasternCities Rental Rules and
                  Terms of Service.
                </span>
              </label>
