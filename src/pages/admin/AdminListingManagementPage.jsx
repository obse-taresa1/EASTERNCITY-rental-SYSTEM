...
const adPlacements = [
  ...
  },
  {
    ...
    advertiser: "BuildRight Tools",
    status: "Scheduled",
    views: "3.1k",
    revenue: "3,500 ETB",
  },
  {
    slot: "Dashboard promo",
    advertiser: "Lens House",
    status: "Active",
    views: "2.7k",
    revenue: "3,900 ETB",
  },
  ...
  return (
    <main className="dashboard-content">
      ...
      <p className="owner-muted">
        Review approvals, featured visibility, rejected/expired listings, and
        sponsored advertisement spaces.
      </p>
        ...
        <div className="owner-section-heading mb-3">
          <div>
            ...
            <p className="owner-muted mb-0">
              Owner-created listings enter pending approval before publication.
            </p>
          </div>
      ...
      <section className="dashboard-section mt-4">
        <div className="owner-section-heading mb-3">
          <div>
            ...
            <p className="owner-muted mb-0">
              Manage homepage banners, category banners, and dashboard
              promotional areas for business advertisers.
            </p>
          </div>
        ...
        <div className="owner-listing-grid">
          {adPlacements.map((placement) => (
            <article className="owner-monetization-card" key={placement.slot}>
              ...
              <small>
                {placement.status} - {placement.views} views -{" "}
                {placement.revenue}
              </small>
            </article>
          ))}
